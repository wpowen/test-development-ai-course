...
const rawProfessionRealityPage: TutorialPage = {
  ...
  outcomes: [
    ...
    "运行红绿修复自测，得到带门禁的个人学习路线",
  ],
  artifact: "职业责任地图、研发测试生命周期图、入场自测报告、版本化职业重建 Prompt 与个人学习路线",
  architecture: {
  ...
  completion: [
    ...
    "个人学习路线每一步都有工件、故障注入和下游决定，不以看完页面作为完成",
  ],
