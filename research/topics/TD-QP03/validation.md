...
PASS-FIXTURE：public working_directory、required files、baseline/fault/repair 和 0/1/0 明确；故障为给 runner 增加 cluster-admin，LEAST-PRIVILEGE 变红；Prompt 有 input/Schema/eval/manifest 与 NOT_RUN model policy。
