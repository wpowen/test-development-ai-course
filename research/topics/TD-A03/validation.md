# AI Serving 指标：TTFT、TPOT、ITL、Goodput 与单位成功成本 validation
...
协议和指标定义来自原始标准或官方文档；“从请求、首 Token、逐 Token 和终态时间戳计算延迟；Goodput 只计质量、安全、完整性和 SLO 同时合格的请求。”属于跨来源工程推论。Unknown 保留：fixture 时间戳和成本不代表任何模型、GPU、地区或供应商。
