...
PASS-FIXTURE：public working_directory、required files、baseline/fault/repair 和 0/1/0 明确；故障为删除必需验收字段，BASIS-COMPLETE 变红；Prompt 有 input/Schema/eval/manifest 与 NOT_RUN model policy。
