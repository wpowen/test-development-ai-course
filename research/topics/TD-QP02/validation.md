...
PASS-FIXTURE：public working_directory、required files、baseline/fault/repair 和 0/1/0 明确；故障为把 MR HEAD 改成另一个 SHA，CURRENT-SHA 变红；Prompt 有 input/Schema/eval/manifest 与 NOT_RUN model policy。
